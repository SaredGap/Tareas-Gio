...
<body>
  ...
  <section class="home-section">
    ...
    <?php foreach($arr_users as $usert) { ?>
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Análisis de Sensor - Zona I</div>
            <div class="number"><?php echo $usert['Temperatura']; ?>°,
      <?php } ?>
              <?php } ?>
        <?php if(!empty($arr_users)) { ?>
    <?php foreach($arr_users as $userh) { ?>
              <?php echo $userh['Humedad']; ?>%</div>
             <?php } ?>
        <?php } ?>
            <div class="indicator">  
            Temperatura - Humedad         
    ...
    <?php foreach($arr_users as $userh) { ?>
        ...
        <?php } ?>
          ...
          <i class='bx bx-info-square cart' onclick="alert('Estoy en Zona VI');"></i>
        </div>
  </section>
